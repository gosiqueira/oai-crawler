...
class OAICrawler():
    ...
    def retrieval(self, repository_list):
        start_time = time()
...
if __name__ == '__main__':
    #OAICrawler().retrieval(parse_repository_file('world_repositories'))
    OAICrawler().retrieval([['AUT University Doctoral Theses','http://aut.researchgateway.ac.nz/dspace-oai/request','col_10292_4','mets']])
